...
DataCell=[ maxX.',minX.',avgX.',stdX.',maxY.',minY.',avgY.',stdY.',maxZ.',minZ.',avgZ.',stdZ.',maxACC.',minACC.',avgACC.',stdACC.',XYcorr.',XZcorr.',YZcorr.',energy.'];

% use of KNN for classification  
load('FeatureTrain.mat');
%Train=xlsread('training dtata');
%Test=xlsread('test');
load('group1.mat');
class=knnclassify(DataCell, FeatureTrain, group);
