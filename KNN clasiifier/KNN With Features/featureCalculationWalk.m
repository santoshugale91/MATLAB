load walk.mat;
accX = walk(:,1)/9.8;%3rd column of the CSV file is the values of Accelerometer X 
accY = walk(:,2)/9.8;%4th column of the CSV file is the values of Accelerometer Y 
accZ = walk(:,3)/9.8;%5th column of the CSV file is the values of Accelerometer Z
[m,n]=size(accX);
%L=floor(m/23);
