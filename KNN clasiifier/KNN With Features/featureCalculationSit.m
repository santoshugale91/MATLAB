load stand.mat;
accX = sit(:,1)/9.8;%3rd column of the CSV file is the values of Accelerometer X 
accY = sit(:,2)/9.8;%4th column of the CSV file is the values of Accelerometer Y 
accZ = sit(:,3)/9.8;%5th column of the CSV file is the values of Accelerometer Z
[m,n]=size(accX);
%L=floor(m/23);
